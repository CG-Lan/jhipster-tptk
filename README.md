...
To build the final jar and optimize the jhipsterTpTk application for production, run:
...
Then navigate to [http://localhost:2312](http://localhost:2312) in your browser.
